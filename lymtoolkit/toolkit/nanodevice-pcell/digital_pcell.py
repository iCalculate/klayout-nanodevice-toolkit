...
class DigitalPCell(pya.PCellDeclarationHelper):
    """PCell wrapper for seven-segment-style text generated by DigitalDisplay."""
    ...
    def produce_impl(self):
        # Helper utilities expect coordinates in nanometer-like integer units.
        # The PCell parameters are exposed to users in micrometers.
        GeometryUtils.UNIT_SCALE = 1000
        ly = self.layout
        cell = self.cell
        layer = self.layer
        # DigitalDisplay returns ready-to-insert pya.Polygon objects.
